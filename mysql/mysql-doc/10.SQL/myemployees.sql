...
CREATE TABLE `employees` (
  ...
  `job_id` varchar(10) DEFAULT NULL COMMENT '工作ID',
  `salary` double(10,2) DEFAULT NULL COMMENT '工资',
  `commission_pct` double(4,2) DEFAULT NULL COMMENT '佣金pct',
  `manager_id` int(6) DEFAULT NULL COMMENT '部门经理ID',
...
CREATE TABLE `jobs` (
  ...
  `job_title` varchar(35) DEFAULT NULL COMMENT '职称',
  `min_salary` int(6) DEFAULT NULL COMMENT '最低工资',
  `max_salary` int(6) DEFAULT NULL COMMENT '最高工资',
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=gb2312 COMMENT='工作表';
...
CREATE TABLE `locations` (
  ...
  `country_id` varchar(2) DEFAULT NULL COMMENT '国家ID',
  PRIMARY KEY (`location_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3201 DEFAULT CHARSET=gb2312 COMMENT='地址表';
